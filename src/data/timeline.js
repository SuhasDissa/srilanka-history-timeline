export const items = [
    ...
    {
        title: "35 BC to 32 BC",
        cardTitle: "Pali Canon (Buddhist scriptures) committed to writing.",
        cardDetailedText: ["Famine and schisms in Sri Lanka point out the need for a written record of the Tipitaka to preserve the Buddhist religion. King Vattagamani convenes a Fourth Council, in which 500 reciters and scribes from the Mahavihara write down the Pali Tipitaka for the first time, on palm leaves."],
    ...
    {
        title: "432 AD to 459 AD",
        cardTitle: "Pandya Conquest",
        cardDetailedText: ["An army from the Kingdom of Pandya in southern India invades Ceylon (present-day Sri Lanka) and overthrows the Lambakanna dynasty, which begun in 65 AD"],
    ...
    },
    {
        ...
        cardDetailedText: ["1597 saw the fall of the Kingdom of Kotte, paving the way for the rise of the Kandyan Kingdom in the central highlands. This kingdom became the symbol of Sri Lankan resistance against European domination."],
        media: {
            type: "IMAGE",
            source: {
                url: "/srilanka-history-timeline/images/old_kandy.jpg"
            }
        }
    },
    {
